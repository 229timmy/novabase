...
export const MediaCard: React.FC<MediaCardProps> = ({ item, onClick }) => {
  ...
  return (
    <motion.div
      ...
      className="relative flex-shrink-0 w-40 sm:w-48 cursor-pointer group hover:z-10 animated-card"
    ...
    >
      <img
        ...
        className="w-full h-60 sm:h-72 object-cover rounded-lg relative z-[1]"
      />
